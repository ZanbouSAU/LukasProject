...
public static partial class Io
{
    ...
    public static void OpenOrCreate(ReadOnlySpan<byte> path)
    {
        File file = new();
    ...
    public static void WriteLineAllBytes(ReadOnlySpan<byte> path, ReadOnlySpan<byte> contents)
    {
        File file = new();
        file.Open(path, Flags.OpenOrCreate);
    ...
    public static void WriteLineAppendAllBytes(ReadOnlySpan<byte> path, ReadOnlySpan<byte> contents)
    {
        File file = new();
        file.Open(path);
        file.Write(contents, isLine: true);
